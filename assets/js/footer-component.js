      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12 mb-8 sm:mb-12">
        ...
        <div class="lg:col-span-1">
          <div class="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            <img src="${logoPath}" alt="FLC Publishing House" class="h-10 sm:h-12 w-auto">
          </div>
          ...
          <div class="flex items-center gap-2 sm:gap-3">
            <a href="#" class="w-11 h-11 sm:w-10 sm:h-10 bg-white/10 hover:bg-flcGold/20 rounded-lg flex items-center justify-center transition-all hover:scale-110 active:scale-95">
        ...
        <div>
          ...
          <!-- Trust Badges -->
          <div class="flex flex-wrap items-center gap-2 sm:gap-3 mt-4 sm:mt-6">
